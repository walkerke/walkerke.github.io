...
Commonly, studies that use US Census data study topics at the scale of the metropolitan area.  However, subsetting Census geographic data by metropolitan area is not always straightforward.  Commonly, such a workflow for Census tracts might look something like: 
